...
const progressPercentage = Math.min(
  ...
  return (
    <div className="group relative">
      <button
        className={`flex items-center gap-2 bg-gray-800/80 hover:bg-gray-700/90 px-3 py-2 rounded-lg border ${colors.border} hover:${colors.hoverBorder} transition-all duration-300 w-full ${isCompleted ? "opacity-50 cursor-not-allowed" : ""} ${isLoading ? "animate-pulse" : ""}`}
