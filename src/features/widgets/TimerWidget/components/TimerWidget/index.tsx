    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {isMiniMode ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
          </button>
          <button
          ...
          >
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm text-zinc-300 pr-2">
                {sessionType === "focus"
                  ? `Foco ${completedSessions}/${config.pomodoros_before_long_break}`
                  : "Pausa"}
              </span>
            </div>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm text-zinc-400">
                <div className="flex items-center gap-1">
                  <Hourglass size={14} /> Foco Completado: {completedSessions}{" "}
                  de {config.pomodoros_before_long_break}
                </div>
                <div className="flex items-center gap-1">
                  <CheckCircle size={14} />{" "}
                  {Math.floor(
                    (completedSessions / config.pomodoros_before_long_break) *
                      100
                  )}
                  %
                </div>
